...
class Laser(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/User/Downloads/KemonitoJuega/platanochikito.png").convert()
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('C:/Users/User/Downloads/KemonitoJuega/kemonito.png').convert()
        self.image.set_colorkey(negro)
        self.rect = self.image.get_rect()
